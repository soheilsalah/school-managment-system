            ...
            <div class="box">
                ...
                <form id="create-new-book">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="tags">وسم</label>
                            <div class="input-group">
                                <input type="text" data-role="tagsinput" placeholder="اضافة اوسمة جديدة" id="tags" name="tags"> 
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="isPublished">هل تريد نشر الكتاب </label>
                        </div>
                    </div>
