...
$(document).ready(function(){
    ...
    $.ajax({
        type : "POST",
        url : "{{ route('instructor.ajax.is-session-recurrsive') }}",
        data : {
            "_token" : "{{ csrf_token() }}",
    ...
    $.ajax({
        type : "POST",
        url : "{{ route('instructor.ajax.create-session.display-all-educational-classes') }}",
        data : {
            "_token" : "{{ csrf_token() }}",
    ...
    $("#create-session").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('instructor.ajax.create-session') }}",
            type : "POST",
