@extends('admin.layouts.app', [
    ...
    'scripts' => 'pages.schedule-session.show',
    'breadcrumb' => [
        'title' => $scheduleSession->belongsToSubject->name,
        'map' => [
        ...
        <div class="box-body">
            <div class="row justify-content-center">
                <div class="col-8">
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-sm-3 col-form-label">بدء المحاضرة</label>
                        <div class="col-sm-9">
                            <a href="{{ $scheduleSession->start_url }}" class="btn btn-success btn-sm" target="_blank">رابط بدء المحاضرة</a>
                        </div>
                    </div>
