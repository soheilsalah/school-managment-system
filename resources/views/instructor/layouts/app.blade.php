...
<head>
  <meta charset="utf-8">
	...
	@include('instructor.includes.assets.styles')
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
    <div class="wrapper">
        ...
        <!-- Header (Navbar) -->
        @include('instructor.includes.navs.navbar')
        
        <!-- Aside (Sidbar) -->
        @include('instructor.includes.navs.sidebar')
	...
	@include('instructor.includes.assets.scripts')
</body>
</html>
