...
<head>
  <meta charset="utf-8">
	...
	@include('financial.includes.assets.styles')
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
    <div class="wrapper">
        ...
        <!-- Header (Navbar) -->
        @include('financial.includes.navs.navbar')
        
        <!-- Aside (Sidbar) -->
        @include('financial.includes.navs.sidebar')
	...
	@include('financial.includes.assets.scripts')
</body>
</html>
