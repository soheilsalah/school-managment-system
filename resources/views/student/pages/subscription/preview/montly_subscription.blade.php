<div class="row">
    @if(isset($educationalClassSubscription->one_month) && $educationalClassSubscription->one_month != null)
    <div class="col-lg-3">
        <div class="box">
    ...
    @if(isset($educationalClassSubscription->three_months) && $educationalClassSubscription->three_months != null)
    <div class="col-lg-3">
    ...
    @if(isset($educationalClassSubscription->six_months) && $educationalClassSubscription->six_months != null)
    <div class="col-lg-3">
        <div class="box">
            <div class="box-body text-center">
            <h3 class="price">
    ...
    @if(isset($educationalClassSubscription->one_year) && $educationalClassSubscription->one_year != null)
    <div class="col-lg-3">
        <div class="box">
            <div class="box-body text-center">
            <h3 class="price">
