...
class SubscriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('student.pages.subscription.index')->with('studentClass', $studentClass);
    }
    ...
    public function checkout($plan_type)
    {
        ...
        return view('student.pages.subscription.checkout')
    ...
    public function previewSubscriptionPlans(Request $request)
    {
        ...
        switch ($plan) {
            case 'all_subject':
                ...
                return view('student.pages.subscription.preview.montly_subscription')->with('educationalClassSubscription', $educationalClassSubscription);
            break;
            ...
            case 'specific_subject':
                ...
                return view('student.pages.subscription.preview.subject')
                ->with('educationalClassSubjects', $educationalClassSubjects)
                ->with('educationalClass', $educationalClass);
            break;

            case 'specific_session':
                $scheduleSessions = ScheduleSession::where('educational_class_id', $educational_class_id)->where('start_at', '>', Carbon::now())->get();
                $educationalClass = EducationalClass::where('id', $educational_class_id)->first();
                
                return view('student.pages.subscription.preview.session')
