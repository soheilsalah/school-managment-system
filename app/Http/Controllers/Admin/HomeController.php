...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $scheduleSessions = ScheduleSession::get();
    ...
    public function previewScheduleSession(Request $request)
    {
        ...
        $start_session_route = route('admin.session.start', $scheduleSession->start_url);
        $join_session_route = route('admin.session.join', $scheduleSession->join_url);
